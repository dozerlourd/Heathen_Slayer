...
namespace HCH
{
    public class MersenneTwister
    {
		...
		private static uint[] mt; /* the array for the state vector  */
		...
		public static uint Genrand_Int32(int num)
		{
			num = Mathf.Min(num, 9);
			uint y;
...
namespace Meisui.Random
{
	...
	public class MersenneTwister
	{
		...
		{
			return ((genrand_Int32()) + 0.5) * ((double)1.0 / 4294967296.0);
			/* divided by 2^32 */
		}
		...
		public double genrand_res53()
		{
			...
			return (a * 67108864.0 + b) * ((double)1.0 / 9007199254740992.0);
		}
